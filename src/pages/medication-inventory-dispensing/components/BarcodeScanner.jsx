// src/pages/medication-inventory-dispensing/components/BarcodeScanner.jsx
      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block w-full max-w-md my-8 overflow-hidden text-left align-middle transition-all transform bg-surface shadow-elevation-3 rounded-lg">
            ...
            <div className="text-center mb-6">
              ...
              {!isScanning && (
                <button
                  ...
                  className="bg-primary text-white px-4 py-2 rounded-md hover:bg-primary/90 transition-colors duration-200 w-full mb-4 flex items-center justify-center space-x-2 rtl:space-x-reverse"
                  disabled={isScanning}
                >
                  <Icon name="Camera" size={18} />
                  <span>{language === 'en' ? 'Start Scanning' : 'بدء المسح'}</span>
                </button>
              )}
            </div>
            ...
            <div className="border-t border-secondary-200 pt-4">
              ...
              <div className="flex space-x-2 rtl:space-x-reverse">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-secondary-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
                  disabled={isScanning}
                />
                <button
                  onClick={handleManualEntry}
                  disabled={!scannedCode.trim() || isScanning}
                  className="px-3 py-2 bg-secondary text-text-primary rounded-md hover:bg-secondary/80 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
          ...
          <div className="flex items-center justify-end space-x-3 rtl:space-x-reverse p-6 border-t border-secondary-200 bg-secondary-50">
            <button
              onClick={handleClose}
              className="px-4 py-2 bg-secondary text-text-primary rounded-md hover:bg-secondary/80 transition-colors duration-200"
              disabled={isScanning}
            >
